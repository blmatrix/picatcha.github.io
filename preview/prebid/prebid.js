...
var _justClone = __webpack_require__(64);
...
var _auction = __webpack_require__(41);
...
var _videoCache = __webpack_require__(192);
  ...
  function callBids() {
    ...
    var call = {
      ...
      run: function run() {
        ...
        adaptermanager.callBids(_adUnits, bidRequests, addBidResponse.bind(_this), done.bind(_this), {
...
var _prebidGlobal = __webpack_require__(39);

var _utils = __webpack_require__(0);

var _secureCreatives = __webpack_require__(525);
...
var _targeting = __webpack_require__(40);

var _hook = __webpack_require__(20);

var _debugging = __webpack_require__(526);
...
pbjs.version = 'v1.17.0-pre';
utils.logInfo('Prebid.js v1.17.0-pre loaded');
...
var _sizeMapping = __webpack_require__(65);
...
var polymorphAdapterSpec = exports.polymorphAdapterSpec = {
  ...
  interpretResponse: function interpretResponse(serverResponse, _ref) {
    ...
    try {
      ...
      console.log('eCPM ====: ' + serverResponse.ecpm);
      var bidResp = {
