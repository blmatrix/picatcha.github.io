function interstitial_call(){
    ...
    rcel.src = "http://trends.revcontent.com/serve.js.php?w=43367&t="+rcel.id+"&c="+(new Date()).getTime()+"&width="+(window.outerWidth || document.documentElement.clientWidth)+"&referer="+referer;
    rcel.async = true;
    var rcds = document.getElementById("rcjsload_b081eb"); rcds.appendChild(rcel);
...
function interstitial_open(){
    ...
    ints_setCookie("m_ints_cookie", "1", "30");
}
