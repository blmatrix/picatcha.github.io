...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		hc : (typeof gemius_hitcollector != 'undefined')?gemius_hitcollector:(typeof pp_gemius_hitcollector != 'undefined')?pp_gemius_hitcollector:'str.hit.gemius.pl',
		...
		sonar : function(sid) {
			...
			while (prob>0) {
				if (data["sdur"]<24*3600 && Math.random() < prob/data["freq"]) {
					...
					gemius_hcconn.internal_hit(0,99,data["id"],data["evid"]+sarg,"sonar",0,0);
				}
