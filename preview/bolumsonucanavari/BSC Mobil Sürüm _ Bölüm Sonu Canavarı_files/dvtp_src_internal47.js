...
0,{}))}}catch(d){return{vdcv:13,vdcd:"0"}}}function za(){try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv)return!0}catch(d){}return!1}function O(d){if(window._dv_win.document.body)return window._dv_win.document.body.insertBefore(d,window._dv_win.document.body.firstChild),!0;var a=0,c=function(){if(window._dv_win.document.body)try{window._dv_win.document.body.insertBefore(d,window._dv_win.document.body.firstChild)}catch(e){}else a++,150>a&&setTimeout(c,20)};setTimeout(c,20);
return!1}function ha(d){var a;if(document.createElement&&(a=document.createElement("iframe")))a.name=a.id=window._dv_win.dv_config.emptyIframeID||"iframe_"+Math.floor(1E12*(Math.random()+"")),a.width=0,a.height=0,a.style.display="none",a.src=d;return a}function Aa(d){var a={};try{for(var c=RegExp("[\\?&]([^&]*)=([^&#]*)","gi"),e=c.exec(d);null!=e;)"eparams"!==e[1]&&(a[e[1]]=e[2]),e=c.exec(d);return a}catch(i){return a}}function db(d){try{if(1>=d.depth)return{url:"",depth:""};var a,c=[];c.push({win:window._dv_win.top,
depth:0});for(var e,i=1,m=0;0<i&&100>m;){try{if(m++,e=c.shift(),i--,0<e.win.location.toString().length&&e.win!=d)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,depth:e.depth-1}}catch(s){}a=e.win.frames.length;for(var f=0;f<a;f++)c.push({win:e.win.frames[f],depth:e.depth+1}),i++}return{url:"",depth:""}}catch(O){return{url:"",depth:""}}}function ia(d){var a=String(),c,e,i;for(c=0;c<d.length;c++)i=d.charAt(c),e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(i),
0<=e&&(i="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((e+47)%94)),a+=i;return a}function eb(){try{if("function"===typeof window.callPhantom)return 99;try{if("function"===typeof window.top.callPhantom)return 99}catch(d){}if(void 0!=window.opera&&void 0!=window.history.navigationMode||void 0!=window.opr&&void 0!=window.opr.addons&&"function"==typeof window.opr.addons.installExtension)return 4;if(void 0!=window.chrome&&"function"==typeof window.chrome.csi&&
...
!1;break}else{0==P&&(s=!0);break}}catch(ub){s=!1}var G;0==f.document.referrer.length?G=f.location:s?G=f.location:(G=f.document.referrer,Ca=!0);var Ea="",ja=null,ka=null;try{window._dv_win.external&&(ja=void 0!=window._dv_win.external.QueuePageID?window._dv_win.external.QueuePageID:null,ka=void 0!=window._dv_win.external.CrawlerUrl?window._dv_win.external.CrawlerUrl:null)}catch(vb){Ea="&dvp_extErr=1"}if(!window._dv_win._dvScriptsInternal||!window._dv_win.dvProcessed||0==window._dv_win._dvScriptsInternal.length)return null;
var Q=window._dv_win._dvScriptsInternal.pop(),C=Q.script;this.dv_script_obj=Q;this.dv_script=C;window._dv_win.t2tTimestampData[0].dvWrapperLoadTime=Q.loadtime;window._dv_win.dvProcessed.push(Q);var b=C.src;if(void 0!=window._dv_win.$dv.CommonData.BrowserId&&void 0!=window._dv_win.$dv.CommonData.BrowserVersion&&void 0!=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent)d=window._dv_win.$dv.CommonData.BrowserId,a=window._dv_win.$dv.CommonData.BrowserVersion,c=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent;
...
verRegex:null},{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}],la=0,Ha="",w=0;w<D.length;w++)if(null!=Ga.match(RegExp(D[w].brRegex))){la=D[w].id;if(null==D[w].verRegex)break;var ma=Ga.match(RegExp(D[w].verRegex+"[0-9]*"));if(null!=ma)var fb=ma[0].match(RegExp(D[w].verRegex)),Ha=ma[0].replace(fb[0],"");break}var Ia=eb();d=Ia;a=Ia===la?Ha:"";c=la;window._dv_win.$dv.CommonData.BrowserId=d;window._dv_win.$dv.CommonData.BrowserVersion=
a;window._dv_win.$dv.CommonData.BrowserIdFromUserAgent=c}var x,gb="https:"===window._dv_win.location.protocol?"https:":"http:",na=!0,oa=window.parent.postMessage&&window.JSON,Ja=!1;if("0"==dv_GetParam(b,"t2te")||window._dv_win.dv_config&&!0===window._dv_win.dv_config.supressT2T)Ja=!0;if(oa&&!1===Ja&&5!=window._dv_win.$dv.CommonData.BrowserId)try{var pa=window._dv_win.dv_config.t2turl||"https://cdn3.doubleverify.com/t2tv7.html";x=ha(pa);na=O(x)}catch(wb){}window._dv_win.$dv.DebugInfo.dvp_HTML5=oa?
"1":"0";var R=dv_GetParam(b,"region")||"",S="http:",Ka="0";"https"==b.match("^https")&&"https"==window._dv_win.location.toString().match("^https")&&(S="https:",Ka="1");try{for(var hb=f,qa=f,ra=0;10>ra&&qa!=window._dv_win.top;)ra++,qa=qa.parent;hb.depth=ra;var La=db(f);dv_aUrlParam="&aUrl="+encodeURIComponent(La.url);dv_aUrlDepth="&aUrlD="+La.depth;dv_referrerDepth=f.depth+Ba;Ca&&f.depth--}catch(xb){dv_aUrlDepth=dv_aUrlParam=dv_referrerDepth=f.depth=""}for(var Ma=dv_GetDynamicParams(b,"dvp"),T=dv_GetDynamicParams(b,
"dvpx"),U=0;U<T.length;U++){var Na=dv_GetKeyValue(T[U]);T[U]=Na.key+"="+encodeURIComponent(Na.value)}"41"==R&&(R=50>100*Math.random()?"41":"8",Ma.push("dvp_region="+R));var Oa=Ma.join("&"),Pa=T.join("&"),ib=window._dv_win.dv_config.tpsAddress||"tps"+R+".doubleverify.com",H="visit.js";switch(dv_GetParam(b,"dvapi")){case "1":H="dvvisit.js";break;case "5":H="query.js";break;default:H="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=H;for(var V="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr dt isdvvid dup app sup".split(" "),
I=[],p=0;p<V.length;p++){var sa=dv_GetParam(b,V[p])||"";I.push(V[p]+"="+sa);""!==sa&&(window._dv_win.$dv.DebugInfo["dvp_"+V[p]]=sa)}var jb=dv_GetParam(b,"isdvvid")||"",Qa=dv_GetParam(b,"tagtype")||"";if(1!=jb&&("video"==Qa||"1"==Qa)){za()||I.push("prplyd=1");var Ra="AICB_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd());window._dv_win[Ra]=function(){e=!0;window._dv_win.$dv&&!0==i&&window._dv_win.$dv.registerEventCall(m,{prplyd:0})};var kb=
...
f.depth+"&curl="+(null==ka?"":encodeURIComponent(ka))+"&qpgid="+(null==ja?"":ja)+"&ssl="+Ka+"&refD="+dv_referrerDepth+"&htmlmsging="+(oa?"1":"0")+y+Ea,v=window._dv_win.$dv.getMraid();v&&(b+="&ismraid=1");za()&&(b+="&isovv=1");var sb=b,j="";try{var r=window._dv_win,j=j+("&chro="+(void 0===r.chrome?"0":"1")),j=j+("&hist="+(r.history?r.history.length:"")),j=j+("&winh="+r.innerHeight),j=j+("&winw="+r.innerWidth),j=j+("&wouh="+r.outerHeight),j=j+("&wouw="+r.outerWidth);r.screen&&(j+="&scah="+r.screen.availHeight,
j+="&scaw="+r.screen.availWidth)}catch(zb){}b=sb+(j||"");"http:"==b.match("^http:")&&"https"==window._dv_win.location.toString().match("^https")&&(b+="&dvp_diffSSL=1");var Wa=C&&C.parentElement&&C.parentElement.tagName&&"HEAD"===C.parentElement.tagName;if(!1===na||Wa)b+="&dvp_isBodyExistOnLoad="+(na?"1":"0"),b+="&dvp_isOnHead="+(Wa?"1":"0");Oa&&(b+="&"+Oa);Pa&&(b+="&"+Pa);var K="srcurl="+encodeURIComponent(G);window._dv_win.$dv.DebugInfo.srcurl=G;var ba;var ca=window._dv_win[ia("=@42E:@?")][ia("2?46DE@C~C:8:?D")];
if(ca&&0<ca.length){var ua=[];ua[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var da=0;da<ca.length;da++)ua[da+1]=ca[da];ba=ua.reverse().join(",")}else ba=null;ba&&(K+="&ancChain="+encodeURIComponent(ba));var L=dv_GetParam(b,"uid");null==L?(L=dv_GetRnd(),b+="&uid="+L):(L=dv_GetRnd(),b=b.replace(/([?&]uid=)(?:[^&])*/i,"$1"+L));var va=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(va=2E3);var Xa=navigator.userAgent.toLowerCase();if(-1<Xa.indexOf("webkit")||
-1<Xa.indexOf("chrome")){var Ya="&referrer="+encodeURIComponent(window._dv_win.location);b.length+Ya.length<=va&&(b+=Ya)}dv_aUrlParam.length+dv_aUrlDepth.length+b.length<=va&&(b+=dv_aUrlDepth,K+=dv_aUrlParam);var Za=cb(),b=b+("&vavbkt="+Za.vdcd),b=b+("&lvvn="+Za.vdcv),b=b+("&"+this.getVersionParamName()+"="+this.getVersion()),b=b+("&eparams="+encodeURIComponent(ia(K))),b=b+("&brid="+d+"&brver="+a+"&bridua="+c);window._dv_win.$dv.DebugInfo.dvp_BRID=d;window._dv_win.$dv.DebugInfo.dvp_BRVR=a;window._dv_win.$dv.DebugInfo.dvp_BRIDUA=
c;var M;void 0!=window._dv_win.$dv.CommonData.Scenario?M=window._dv_win.$dv.CommonData.Scenario:(M=this.getTrafficScenarioType(window._dv_win),window._dv_win.$dv.CommonData.Scenario=M);b+="&tstype="+M;window._dv_win.$dv.DebugInfo.dvp_TS=M;var ea="";try{window.top==window?ea="1":window.top.location.host==window.location.host&&(ea="2")}catch(Ab){ea="3"}var fa=window._dv_win.document.visibilityState,$a=function(){var a=!1;try{a=v&&"function"===typeof v.getState&&"loading"===v.getState()}catch(d){b+=
"&dvp_mrgsf=1"}return a},wa=$a();if("prerender"===fa||wa)b+="&prndr=1",wa&&(b+="&dvp_mrprndr=1");var ab="dvCallback_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd()),tb=this.dv_script;window._dv_win[ab]=function(a,d,c,f){var g=getCurrentTime();i=!0;m=c;d.$uid=c;d=Aa(Va);a.tags.add(c,d);d=Aa(b);a.tags[c].set(d);a.tags[c].beginVisitCallbackTS=g;a.tags[c].set({tagElement:tb,dv_protocol:S,protocol:gb,uid:c});a.tags[c].ImpressionServedTime=
getCurrentTime();a.tags[c].getTimeDiff=function(){return(new Date).getTime()-this.ImpressionServedTime};try{"undefined"!=typeof f&&null!==f&&(a.tags[c].ServerPublicDns=f),a.tags[c].adServingScenario=ea,a.tags[c].t2tIframeCreationTime=Da,a.tags[c].t2tProcessed=!1,a.tags[c].t2tIframeId=x.id,a.tags[c].t2tIframeWindow=x.contentWindow,$dv.t2tEventDataZombie[x.id]&&(a.tags[c].uniquePageViewId=$dv.t2tEventDataZombie[x.id].uniquePageViewId,$dv.processT2TEvent($dv.t2tEventDataZombie[x.id],a.tags[c]))}catch(j){}!0==
...
a+"<\/script></body></html>";c=ha("about:blank");this.dv_script.id=c.id.replace("iframe","script");dv_GetParam(d,"uid");O(c);d=dv_getPropSafe(c,"contentDocument")||dv_getPropSafe(dv_getPropSafe(c,"contentWindow"),"document")||dv_getPropSafe(window._dv_win.frames[c.name],"document");window._dv_win.t2tTimestampData.push({beforeVisitCall:getCurrentTime()});if(d){d.open();if(c=c.contentWindow||window._dv_win.frames[c.name])c.$dv=window._dv_win.$dv;d.write(a)}else d=a.replace(/'/g,"\\'"),d='javascript: (function(){document.open(); document.domain="'+
window.document.domain+"\"; window.$dv = window.parent.$dv; document.write('"+encodeURIComponent(d)+"');})()",c=ha(d),this.dv_script.id=c.id.replace("iframe","script"),O(c);return!0};this.isApplicable=function(){return!0};this.onFailure=function(){window._dv_win._dvScriptsInternal.unshift(this.dv_script_obj);var d=window._dv_win.dvProcessed,a=this.dv_script_obj;null!=d&&(void 0!=d&&a)&&(a=d.indexOf(a),-1!=a&&d.splice(a,1));return window._dv_win.$dv.DebugInfo};this.getTrafficScenarioType=function(d){var d=
d||window,a=d._dv_win.$dv.Enums.TrafficScenario;try{if(d.top==d)return a.OnPage;for(var c=0;d.parent!=d&&1E3>c;){if(d.parent.document.domain!=d.document.domain)return a.CrossDomain;d=d.parent;c++}return a.SameDomain}catch(e){}return a.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"89"}};
...
try {
	...
	dv_handler90.prototype = dv_baseHandlerIns;
dv_handler90.prototype.constructor = dv_handler90;

    var dv_handlersDefs = [{handler: new dv_handler90(), minRate: 0, maxRate: 10}];
