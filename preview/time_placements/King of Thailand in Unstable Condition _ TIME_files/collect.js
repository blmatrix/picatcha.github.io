...
var _etmc = {
  ...
  getCurrentPageUri: function() {
    var decodedUri = "";
    try {
      decodedUri = decodeURI(this.getCurrentLocation())
    } catch (e) {
      decodedUri = this.unescapeUri(this.getCurrentLocation())
    }
  ...
  trackPageView: function(args) {
    ...
    if (this.org_id) {
      ...
      pageView.url = pageView.url || this.getCurrentPageUri();
