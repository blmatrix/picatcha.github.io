...
0,{}));d.hasOwnProperty("err")&&(a=d.err);return{vdcv:23,vdcd:d.res,err:a}}catch(c){return{vdcv:23,vdcd:"0",err:a}}}function sa(a,d,c){var c=c||150,e=window._dv_win||window;if(e.document&&e.document.body)return d&&d.parentNode?d.parentNode.insertBefore(a,d):e.document.body.insertBefore(a,e.document.body.firstChild),!0;if(0<c)setTimeout(function(){sa(a,d,--c)},20);else return!1}function Pa(a){var d=null;try{if(d=a&&a.contentDocument)return d}catch(c){}try{if(d=a.contentWindow&&a.contentWindow.document)return d}catch(e){}try{if(d=
window._dv_win.frames&&window._dv_win.frames[a.name]&&window._dv_win.frames[a.name].document)return d}catch(i){}return null}function Qa(a){var d=document.createElement("iframe");d.name=d.id=window._dv_win.dv_config.emptyIframeID||"iframe_"+Math.floor(1E12*(Math.random()+""));d.width=0;d.height=0;d.style.display="none";d.src=a;return d}function Ra(a){var d={};try{for(var c=RegExp("[\\?&]([^&]*)=([^&#]*)","gi"),e=c.exec(a);null!=e;)"eparams"!==e[1]&&(d[e[1]]=e[2]),e=c.exec(a);return d}catch(i){return d}}
function Ab(a){try{if(1>=a.depth)return{url:"",depth:""};var d,c=[];c.push({win:window._dv_win.top,depth:0});for(var e,i=1,s=0;0<i&&100>s;){try{if(s++,e=c.shift(),i--,0<e.win.location.toString().length&&e.win!=a)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,depth:e.depth-1}}catch(j){}d=e.win.frames.length;for(var l=0;l<d;l++)c.push({win:e.win.frames[l],depth:e.depth+1}),i++}return{url:"",depth:""}}catch(z){return{url:"",depth:""}}}
function ta(a){var d=String(),c,e,i;for(c=0;c<a.length;c++)i=a.charAt(c),e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(i),0<=e&&(i="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((e+47)%94)),d+=i;return d}function Bb(){try{if("function"===typeof window.callPhantom)return 99;try{if("function"===typeof window.top.callPhantom)return 99}catch(a){}if(void 0!=window.opera&&void 0!=window.history.navigationMode||
...
e=0;e<c.length;e++){var h=c[e],f=h.name.match(/.*\/(.+?)\./);if(f&&f[1]){var j=f[1].replace(/\d+$/,""),A=b[j];if(A){for(var g=0;g<A.stats.length;g++){var l=A.stats[g];d[A.prefix+l.prefix]=Math.round(h[l.name])}delete b[j];if(!i(b))break}}}return d}catch(q){}}function i(a){var b=0,d;for(d in a)a.hasOwnProperty(d)&&++b;return b}window._dv_win.$dv.isEval=1;window._dv_win.$dv.DebugInfo={};var s=!1,j=!1,l,z,I=!1,f=window._dv_win,Sa=0,Ta=!1,Ua=getCurrentTime();window._dv_win.t2tTimestampData=[{dvTagCreated:Ua}];
var V;try{for(V=0;10>=V;V++)if(null!=f.parent&&f.parent!=f)if(0<f.parent.location.toString().length)f=f.parent,Sa++,I=!0;else{I=!1;break}else{0==V&&(I=!0);break}}catch(Pa){I=!1}var N;0==f.document.referrer.length?N=f.location:I?N=f.location:(N=f.document.referrer,Ta=!0);var Va="",ua=null,va=null;try{window._dv_win.external&&(ua=void 0!=window._dv_win.external.QueuePageID?window._dv_win.external.QueuePageID:null,va=void 0!=window._dv_win.external.CrawlerUrl?window._dv_win.external.CrawlerUrl:null)}catch(Vb){Va=
"&dvp_extErr=1"}if(!window._dv_win._dvScriptsInternal||!window._dv_win.dvProcessed||0==window._dv_win._dvScriptsInternal.length)return null;var W=window._dv_win._dvScriptsInternal.pop(),J=W.script;this.dv_script_obj=W;this.dv_script=J;window._dv_win.t2tTimestampData[0].dvWrapperLoadTime=W.loadtime;window._dv_win.dvProcessed.push(W);var b=J.src;if(void 0!=window._dv_win.$dv.CommonData.BrowserId&&void 0!=window._dv_win.$dv.CommonData.BrowserVersion&&void 0!=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent)a=
window._dv_win.$dv.CommonData.BrowserId,d=window._dv_win.$dv.CommonData.BrowserVersion,c=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent;else{for(var Wa=dv_GetParam(b,"useragent"),Xa=Wa?decodeURIComponent(Wa):navigator.userAgent,K=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/",verRegex:"(MSIE |rv:| Edge/)"},{id:2,brRegex:"Firefox",verRegex:"Firefox/"},{id:0,brRegex:"Mozilla.*Android.*AppleWebKit(?!.*Chrome.*)|Linux.*Android.*AppleWebKit.* Version/.*Chrome",
verRegex:null},{id:0,brRegex:"AOL/.*AOLBuild/|AOLBuild/.*AOL/|Puffin|Maxthon|Valve|Silk|PLAYSTATION|PlayStation|Nintendo|wOSBrowser",verRegex:null},{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}],wa=0,Ya="",B=0;B<K.length;B++)if(null!=Xa.match(RegExp(K[B].brRegex))){wa=K[B].id;if(null==K[B].verRegex)break;var xa=Xa.match(RegExp(K[B].verRegex+"[0-9]*"));if(null!=xa)var Cb=xa[0].match(RegExp(K[B].verRegex)),Ya=xa[0].replace(Cb[0],
"");break}var Za=Bb();a=Za;d=Za===wa?Ya:"";c=wa;window._dv_win.$dv.CommonData.BrowserId=a;window._dv_win.$dv.CommonData.BrowserVersion=d;window._dv_win.$dv.CommonData.BrowserIdFromUserAgent=c}var C,ya=!0,za=window.parent.postMessage&&window.JSON,$a=!1;if("0"==dv_GetParam(b,"t2te")||window._dv_win.dv_config&&!0===window._dv_win.dv_config.supressT2T)$a=!0;if(za&&!1===$a&&5!=window._dv_win.$dv.CommonData.BrowserId)try{C=Qa(window._dv_win.dv_config.t2turl||"https://cdn3.doubleverify.com/t2tv7.html"),
ya=sa(C)}catch(Wb){}window._dv_win.$dv.DebugInfo.dvp_HTML5=za?"1":"0";var X=dv_GetParam(b,"region")||"",Y;Y=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream;var Aa;if(Y)Aa="https:";else{var ab="http:";"http:"!=window._dv_win.location.protocol&&(ab="https:");Aa=ab}var Db=Aa,Ba;if(Y)Ba="https:";else{var bb="http:";if("https"==b.match("^https")&&("http"!=window._dv_win.location.toString().match("^http")||
"https"==window._dv_win.location.toString().match("^https")))bb="https:";Ba=bb}var Z=Ba,cb="0";"https:"===Z&&(cb="1");try{for(var Eb=f,Ca=f,Da=0;10>Da&&Ca!=window._dv_win.top;)Da++,Ca=Ca.parent;Eb.depth=Da;var db=Ab(f);dv_aUrlParam="&aUrl="+encodeURIComponent(db.url);dv_aUrlDepth="&aUrlD="+db.depth;dv_referrerDepth=f.depth+Sa;Ta&&f.depth--}catch(Xb){dv_aUrlDepth=dv_aUrlParam=dv_referrerDepth=f.depth=""}for(var eb=dv_GetDynamicParams(b,"dvp"),$=dv_GetDynamicParams(b,"dvpx"),aa=0;aa<$.length;aa++){var fb=
dv_GetKeyValue($[aa]);$[aa]=fb.key+"="+encodeURIComponent(fb.value)}"41"==X&&(X=50>100*Math.random()?"41":"8",eb.push("dvp_region="+X));var gb=eb.join("&"),hb=$.join("&"),Fb=window._dv_win.dv_config.tpsAddress||"tps"+X+".doubleverify.com",O="visit.js";switch(dv_GetParam(b,"dvapi")){case "1":O="dvvisit.js";break;case "5":O="query.js";break;default:O="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=O;for(var ba="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr dt dup app sup dvvidver".split(" "),
p=[],r=0;r<ba.length;r++){var Ea=dv_GetParam(b,ba[r])||"";p.push(ba[r]+"="+Ea);""!==Ea&&(window._dv_win.$dv.DebugInfo["dvp_"+ba[r]]=Ea)}for(var Fa="turl icall dv_callback useragent xff timecheck seltag sadv ord litm scrt invs splc adu".split(" "),r=0;r<Fa.length;r++){var ib=dv_GetParam(b,Fa[r]);null!=ib&&p.push(Fa[r]+"="+(ib||""))}var jb=dv_GetParam(b,"isdvvid")||"";jb&&p.push("isdvvid=1");var kb=dv_GetParam(b,"tagtype")||"",w=window._dv_win.$dv.getMraid(),Ga;a:{try{if("object"==typeof window.$ovv||
"object"==typeof window.parent.$ovv){Ga=!0;break a}}catch(Yb){}Ga=!1}if(1!=jb&&!w&&("video"==kb||"1"==kb)){var lb=dv_GetParam(b,"adid")||"";"function"===typeof _dv_win[lb]&&(p.push("prplyd=1"),p.push("DVP_GVACB="+lb),p.push("isdvvid=1"));var mb="AICB_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd());window._dv_win[mb]=function(a){s=!0;l=a;window._dv_win.$dv&&!0==j&&window._dv_win.$dv.registerEventCall(z,{prplyd:0,dvvidver:a})};p.push("AICB="+
mb);var Gb=p.join("&"),nb=window._dv_win.document.createElement("script");nb.src=Z+"//cdn.doubleverify.com/dvvid_src.js?"+Gb;window._dv_win.document.body.appendChild(nb)}try{var P=e(window,{dvtp_src:{prefix:"d",stats:[{name:"fetchStart",prefix:"fs"},{name:"duration",prefix:"dur"}]},dvtp_src_internal:{prefix:"dv",stats:[{name:"duration",prefix:"dur"}]}});if(!P||!i(P))p.push("dvp_noperf=1");else for(var Ha in P)P.hasOwnProperty(Ha)&&p.push(Ha+"="+P[Ha])}catch(Zb){}var Hb=p.join("&"),D;var Ib=function(){try{return!!window.sessionStorage}catch(a){return!0}},
Jb=function(){try{return!!window.localStorage}catch(a){return!0}},Kb=function(){var a=document.createElement("canvas");if(a.getContext&&a.getContext("2d")){var b=a.getContext("2d");b.textBaseline="top";b.font="14px 'Arial'";b.textBaseline="alphabetic";b.fillStyle="#f60";b.fillRect(0,0,62,20);b.fillStyle="#069";b.fillText("!image!",2,15);b.fillStyle="rgba(102, 204, 0, 0.7)";b.fillText("!image!",4,17);return a.toDataURL()}return null};try{var t=[];t.push(["lang",navigator.language||navigator.browserLanguage]);
t.push(["tz",(new Date).getTimezoneOffset()]);t.push(["hss",Ib()?"1":"0"]);t.push(["hls",Jb()?"1":"0"]);t.push(["odb",typeof window.openDatabase||""]);t.push(["cpu",navigator.cpuClass||""]);t.push(["pf",navigator.platform||""]);t.push(["dnt",navigator.doNotTrack||""]);t.push(["canv",Kb()]);var k=t.join("=!!!=");if(null==k||""==k)D="";else{for(var Q=function(a){for(var b="",d,c=7;0<=c;c--)d=a>>>4*c&15,b+=d.toString(16);return b},Lb=[1518500249,1859775393,2400959708,3395469782],k=k+String.fromCharCode(128),
E=Math.ceil((k.length/4+2)/16),F=Array(E),q=0;q<E;q++){F[q]=Array(16);for(var G=0;16>G;G++)F[q][G]=k.charCodeAt(64*q+4*G)<<24|k.charCodeAt(64*q+4*G+1)<<16|k.charCodeAt(64*q+4*G+2)<<8|k.charCodeAt(64*q+4*G+3)}F[E-1][14]=8*(k.length-1)/Math.pow(2,32);F[E-1][14]=Math.floor(F[E-1][14]);F[E-1][15]=8*(k.length-1)&4294967295;for(var ca=1732584193,da=4023233417,ea=2562383102,fa=271733878,ga=3285377520,m=Array(80),L,n,x,y,ha,q=0;q<E;q++){for(var h=0;16>h;h++)m[h]=F[q][h];for(h=16;80>h;h++)m[h]=(m[h-3]^m[h-
8]^m[h-14]^m[h-16])<<1|(m[h-3]^m[h-8]^m[h-14]^m[h-16])>>>31;L=ca;n=da;x=ea;y=fa;ha=ga;for(h=0;80>h;h++){var ob=Math.floor(h/20),Mb=L<<5|L>>>27,M;c:{switch(ob){case 0:M=n&x^~n&y;break c;case 1:M=n^x^y;break c;case 2:M=n&x^n&y^x&y;break c;case 3:M=n^x^y;break c}M=void 0}var Nb=Mb+M+ha+Lb[ob]+m[h]&4294967295;ha=y;y=x;x=n<<30|n>>>2;n=L;L=Nb}ca=ca+L&4294967295;da=da+n&4294967295;ea=ea+x&4294967295;fa=fa+y&4294967295;ga=ga+ha&4294967295}D=Q(ca)+Q(da)+Q(ea)+Q(fa)+Q(ga)}}catch($b){D=null}D=null!=D?"&aadid="+
D:"";var pb=b,Ob=Y?"&dvf=0":"",b=(window._dv_win.dv_config.visitJSURL||Z+"//"+Fb+"/"+O)+"?"+Hb+"&dvtagver=6.1.src&srcurlD="+f.depth+"&curl="+(null==va?"":encodeURIComponent(va))+"&qpgid="+(null==ua?"":ua)+"&ssl="+cb+Ob+"&refD="+dv_referrerDepth+"&htmlmsging="+(za?"1":"0")+D+Va;w&&(b+="&ismraid=1");Ga&&(b+="&isovv=1");var Pb=b,g="";try{var u=window._dv_win,g=g+("&chro="+(void 0===u.chrome?"0":"1")),g=g+("&hist="+(u.history?u.history.length:"")),g=g+("&winh="+u.innerHeight),g=g+("&winw="+u.innerWidth),
g=g+("&wouh="+u.outerHeight),g=g+("&wouw="+u.outerWidth);u.screen&&(g+="&scah="+u.screen.availHeight,g+="&scaw="+u.screen.availWidth)}catch(ac){}b=Pb+(g||"");"http:"==b.match("^http:")&&"https"==window._dv_win.location.toString().match("^https")&&(b+="&dvp_diffSSL=1");var qb=J&&J.parentElement&&J.parentElement.tagName&&"HEAD"===J.parentElement.tagName;if(!1===ya||qb)b+="&dvp_isBodyExistOnLoad="+(ya?"1":"0"),b+="&dvp_isOnHead="+(qb?"1":"0");gb&&(b+="&"+gb);hb&&(b+="&"+hb);var R="srcurl="+encodeURIComponent(N);
window._dv_win.$dv.DebugInfo.srcurl=N;var ia;var ja=window._dv_win[ta("=@42E:@?")][ta("2?46DE@C~C:8:?D")];if(ja&&0<ja.length){var Ia=[];Ia[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var ka=0;ka<ja.length;ka++)Ia[ka+1]=ja[ka];ia=Ia.reverse().join(",")}else ia=null;ia&&(R+="&ancChain="+encodeURIComponent(ia));var S=dv_GetParam(b,"uid");null==S?(S=dv_GetRnd(),b+="&uid="+S):(S=dv_GetRnd(),b=b.replace(/([?&]uid=)(?:[^&])*/i,"$1"+S));var la=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&
7>=new Number(RegExp.$1)&&(la=2E3);var rb=navigator.userAgent.toLowerCase();if(-1<rb.indexOf("webkit")||-1<rb.indexOf("chrome")){var sb="&referrer="+encodeURIComponent(window._dv_win.location);b.length+sb.length<=la&&(b+=sb)}if(navigator&&navigator.userAgent){var tb="&navUa="+encodeURIComponent(navigator.userAgent);b.length+tb.length<=la&&(b+=tb)}dv_aUrlParam.length+dv_aUrlDepth.length+b.length<=la&&(b+=dv_aUrlDepth,R+=dv_aUrlParam);var ma=zb(),b=b+("&vavbkt="+ma.vdcd),b=b+("&lvvn="+ma.vdcv),b=b+
("&"+this.getVersionParamName()+"="+this.getVersion()),b=b+("&eparams="+encodeURIComponent(ta(R)));""!=ma.err&&(b+="&dvp_idcerr="+encodeURIComponent(ma.err));b+="&brid="+a+"&brver="+d+"&bridua="+c;window._dv_win.$dv.DebugInfo.dvp_BRID=a;window._dv_win.$dv.DebugInfo.dvp_BRVR=d;window._dv_win.$dv.DebugInfo.dvp_BRIDUA=c;var T;void 0!=window._dv_win.$dv.CommonData.Scenario?T=window._dv_win.$dv.CommonData.Scenario:(T=this.getTrafficScenarioType(window._dv_win),window._dv_win.$dv.CommonData.Scenario=T);
b+="&tstype="+T;window._dv_win.$dv.DebugInfo.dvp_TS=T;var na="";try{window.top==window?na="1":window.top.location.host==window.location.host&&(na="2")}catch(bc){na="3"}var oa=window._dv_win.document.visibilityState,ub=function(){var a=!1;try{a=w&&"function"===typeof w.getState&&"loading"===w.getState()}catch(d){b+="&dvp_mrgsf=1"}return a},Ja=ub();if("prerender"===oa||Ja)b+="&prndr=1",Ja&&(b+="&dvp_mrprndr=1");var vb="dvCallback_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():
dv_GetRnd()),Qb=this.dv_script;window._dv_win[vb]=function(a,d,c,f){var h=getCurrentTime();j=!0;z=c;d.$uid=c;var g=Ra(pb);a.tags.add(c,g);g=Ra(b);a.tags[c].set(g);a.tags[c].beginVisitCallbackTS=h;a.tags[c].set({tagElement:Qb,dv_protocol:Z,protocol:Db,uid:c});a.tags[c].ImpressionServedTime=getCurrentTime();a.tags[c].getTimeDiff=function(){return(new Date).getTime()-this.ImpressionServedTime};try{"undefined"!=typeof f&&null!==f&&(a.tags[c].ServerPublicDns=f),a.tags[c].adServingScenario=na,a.tags[c].t2tIframeCreationTime=
Ua,a.tags[c].t2tProcessed=!1,a.tags[c].t2tIframeId=C.id,a.tags[c].t2tIframeWindow=C.contentWindow,$dv.t2tEventDataZombie[C.id]&&(a.tags[c].uniquePageViewId=$dv.t2tEventDataZombie[C.id].uniquePageViewId,$dv.processT2TEvent($dv.t2tEventDataZombie[C.id],a.tags[c]))}catch(q){}a.messages&&a.messages.startSendingEvents&&a.messages.startSendingEvents(d,c);!0==s&&a.registerEventCall(c,{prplyd:0,dvvidver:l});var p=function(){var b=window._dv_win.document.visibilityState;"prerender"===oa&&("prerender"!==b&&
"unloaded"!==b)&&(oa=b,a.tags[c].set({prndr:0}),a.registerEventCall(c,{prndr:0}),a&&a.pubSub&&a.pubSub.publishHistoryRtnEvent(c),window._dv_win.document.removeEventListener(k,p))},A=function(){"function"===typeof w.removeEventListener&&w.removeEventListener("ready",A);a.tags[c].set({prndr:0});a.registerEventCall(c,{prndr:0});a&&a.pubSub&&a.pubSub.publishHistoryRtnEvent(c)};if("prerender"===oa)if(d=window._dv_win.document.visibilityState,"prerender"!==d&&"unloaded"!==d)a.tags[c].set({prndr:0}),a.registerEventCall(c,
{prndr:0}),a&&a.pubSub&&a.pubSub.publishHistoryRtnEvent(c);else{var k;"undefined"!==typeof window._dv_win.document.hidden?k="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?k="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?k="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(k="webkitvisibilitychange");window._dv_win.document.addEventListener(k,p,!1)}else Ja&&(ub()?"function"===typeof w.addEventListener&&w.addEventListener("ready",
A):(a.tags[c].set({prndr:0}),a.registerEventCall(c,{prndr:0}),a&&a.pubSub&&a.pubSub.publishHistoryRtnEvent(c)));try{var m;a:{var d=window,f={visit:{prefix:"v",stats:[{name:"duration",prefix:"dur"}]}},n;if(d.frames)for(h=0;h<d.frames.length;h++)if((n=e(d.frames[h],f))&&i(n)){m=n;break a}m=void 0}m&&$dv.registerEventCall(c,m)}catch(r){}};var pa;try{var Ka=0,qa=function(a,b){b&&32>a&&(Ka=(Ka|1<<a)>>>0)},Rb=function(a,b){return function(){return a.apply(b,arguments)}},Sb="svg"===document.documentElement.nodeName.toLowerCase(),
wb=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):Sb?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},Tb=["Moz","O","ms","Webkit"],Ub=["moz","o","ms","webkit"],v={style:wb("modernizr").style},La=function(a,b,c,d,e){var f=a.charAt(0).toUpperCase()+a.slice(1),h=(a+" "+Tb.join(f+" ")+f).split(" ");if("string"===typeof b||"undefined"===typeof b){a:{c=h;a=function(){i&&(delete v.style,
delete v.modElem)};e="undefined"===typeof e?!1:e;if("undefined"!==typeof d&&(f=nativeTestProps(c,d),"undefined"!==typeof f)){b=f;break a}for(var i,g,j,f=["modernizr","tspan","samp"];!v.style&&f.length;)i=!0,v.modElem=wb(f.shift()),v.style=v.modElem.style;h=c.length;for(f=0;f<h;f++)if(g=c[f],j=v.style[g],~(""+g).indexOf("-")&&(g=cssToDOM(g)),void 0!==v.style[g])if(!e&&"undefined"!==typeof d){try{v.style[g]=d}catch(k){}if(v.style[g]!=j){a();b="pfx"==b?g:!0;break a}}else{a();b="pfx"==b?g:!0;break a}a();
b=!1}return b}h=(a+" "+Ub.join(f+" ")+f).split(" ");for(g in h)if(h[g]in b){if(!1===c)return h[g];d=b[h[g]];return"function"===typeof d?Rb(d,c||b):d}return!1};qa(0,!0);var Ma;var H="requestFileSystem",xb=window;0===H.indexOf("@")?Ma=atRule(H):(-1!=H.indexOf("-")&&(H=cssToDOM(H)),Ma=xb?La(H,xb,void 0):La(H,"pfx"));qa(1,!!Ma);qa(2,window.CSS?"function"==typeof window.CSS.escape:!1);qa(3,La("shapeOutside","content-box",!0));pa=Ka}catch(cc){pa=0}pa&&(b+="&m1="+pa);for(var yb,ra="auctionid vermemid source buymemid anadvid ioid cpgid cpid sellerid pubid advcode iocode cpgcode cpcode pubcode prcpaid auip auua".split(" "),
Na=[],U=0;U<ra.length;U++){var Oa=dv_GetParam(pb,ra[U]);null!=Oa&&(Na.push("dvp_"+ra[U]+"="+Oa),Na.push(ra[U]+"="+Oa))}(yb=Na.join("&"))&&(b+="&"+yb);return b+"&jsCallback="+vb};this.sendRequest=function(a){window._dv_win.t2tTimestampData.push({beforeVisitCall:getCurrentTime()});var d=this.dv_script_obj&&this.dv_script_obj.injScripts,c=this.getVersionParamName(),e=this.getVersion(),i=window._dv_win.dv_config=window._dv_win.dv_config||{};i.tpsErrAddress=i.tpsAddress||"tps30.doubleverify.com";i.cdnAddress=
i.cdnAddress||"cdn.doubleverify.com";var s={};s[c]=e;s.dvp_jsErrUrl=a;s.dvp_jsErrMsg=encodeURIComponent("Error loading visit.js");c=dv_CreateAndGetErrorImp(i.tpsErrAddress+"/visit.jpg?ctx=818052&cmp=1619415&dvtagver=6.1.src&dvp_isLostImp=1",s);d='<html><head><script type="text/javascript">('+function(){try{window.$dv=window.$dv||parent.$dv,window.$dv.dvObjType="dv",window.$frmId=Math.random().toString(36)+Math.random().toString(36)}catch(a){}}.toString()+')();<\/script></head><body><script type="text/javascript">('+
(d||"function() {}")+')("'+i.cdnAddress+'");<\/script><script type="text/javascript" id="TPSCall" src="'+a+'"><\/script><script type="text/javascript">('+function(a){var c=document.getElementById("TPSCall");try{c.onerror=function(){try{(new Image).src=a}catch(c){}}}catch(d){}c&&c.readyState?(c.onreadystatechange=function(){"complete"==c.readyState&&document.close()},"complete"==c.readyState&&document.close()):document.close()}.toString()+')("'+c+'");<\/script></body></html>';a=Qa("about:blank");i=
a.id.replace("iframe_","");a.setAttribute&&a.setAttribute("data-dv-frm",i);sa(a,this.dv_script);if(this.dv_script){this.dv_script.id="script_"+i;var i=this.dv_script,j;a:{c=null;try{if(c=a.contentWindow){j=c;break a}}catch(l){}try{if(c=window._dv_win.frames&&window._dv_win.frames[a.name]){j=c;break a}}catch(z){}j=null}i.dvFrmWin=j}if(j=Pa(a))j.open(),j.write(d);else{try{document.domain=document.domain}catch(I){}j=encodeURIComponent(d.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));a.src='javascript: (function(){document.open();document.domain="'+
window.document.domain+"\";document.write('"+j+"');})()"}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){window._dv_win._dvScriptsInternal.unshift(this.dv_script_obj);var a=window._dv_win.dvProcessed,d=this.dv_script_obj;null!=a&&(void 0!=a&&d)&&(d=a.indexOf(d),-1!=d&&a.splice(d,1));return window._dv_win.$dv.DebugInfo};this.getTrafficScenarioType=function(a){var a=a||window,d=a._dv_win.$dv.Enums.TrafficScenario;try{if(a.top==a)return d.OnPage;for(var c=0;a.parent!=a&&1E3>
c;){if(a.parent.document.domain!=a.document.domain)return d.CrossDomain;a=a.parent;c++}return d.SameDomain}catch(e){}return d.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"121"}};
...
e=0;e<b.length;e++){var f=b[e],h=f.name.match(/.*\/(.+?)\./);if(h&&h[1]){var j=h[1].replace(/\d+$/,""),i=c[j];if(i){for(var k=0;k<i.stats.length;k++){var m=i.stats[k];d[i.prefix+m.prefix]=Math.round(f[m.name])}delete c[j];if(!g(c))break}}}return d}catch(p){}}function g(a){var c=0,d;for(d in a)a.hasOwnProperty(d)&&++c;return c}window._dv_win.$dv.isEval=0;window._dv_win.$dv.DebugInfo={};var t=!1,j=!1,k,y,F=!1,h=window._dv_win,Ka=0,La=!1,Ma=getCurrentTime();window._dv_win.t2tTimestampData=[{dvTagCreated:Ma}];
...
try {
	...
	dv_handler121.prototype = dv_baseHandlerIns;
dv_handler121.prototype.constructor = dv_handler121;

    var dv_handlersDefs = [{handler: new dv_handler121(), minRate: 0, maxRate: 90}];
