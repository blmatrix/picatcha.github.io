...
function dv_handler53(){function Q(c){var b="http:",a=window._dv_win.location.toString().match("^http(?:s)?");if("https"==c.match("^https")&&("https"==a||"http"!=a))b="https:";return b}function C(c){var b=window._dv_win.dvRecoveryObj;if(b){var a=dv_GetParam(c.dvparams,"ctx",!0),b=b[a]?b[a].RecoveryTagID:b._fallback_?b._fallback_.RecoveryTagID:1;1===b&&c.tagsrc?document.write(c.tagsrc):2===b&&c.altsrc&&document.write(c.altsrc);return!0}return!1}function R(){var c;c=!window._dv_win.dv_config||!window._dv_win.dv_config.isUT?
window._dv_win.bsredirect5ScriptsInternal.pop():window._dv_win.bsredirect5ScriptsInternal[window._dv_win.bsredirect5ScriptsInternal.length-1];window._dv_win.bsredirect5Processed.push(c);return c}function S(c,b){var a=document.createElement("iframe");a.name=a.id="iframe_"+dv_GetRnd();a.width=0;a.height=0;a.id=b;a.style.display="none";a.src=c;return a}function I(c,b,a){var a=a||150,d=window._dv_win||window;if(d.document&&d.document.body)return b&&b.parentNode?b.parentNode.insertBefore(c,b):d.document.body.insertBefore(c,
d.document.body.firstChild),!0;if(0<a)setTimeout(function(){I(c,b,--a)},20);else return!1}function J(c){var b=null;try{if(b=c&&c.contentDocument)return b}catch(a){}try{if(b=c.contentWindow&&c.contentWindow.document)return b}catch(d){}try{if(b=window._dv_win.frames&&window._dv_win.frames[c.name]&&window._dv_win.frames[c.name].document)return b}catch(i){}return null}function K(c,b,a,d,i,e,p){var f,g;f=window._dv_win.dv_config&&window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:dv_GetRnd();
var h,l=window.parent.postMessage&&window.JSON;g=!0;var q=!1;if("0"==dv_GetParam(c.dvparams,"t2te")||window._dv_win.dv_config&&!0==window._dv_win.dv_config.supressT2T)q=!0;if(l&&!1==q)try{q="https://cdn3.doubleverify.com/bst2tv3.html",window._dv_win&&(window._dv_win.dv_config&&window._dv_win.dv_config.bst2turl)&&(q=window._dv_win.dv_config.bst2turl),h=S(q,"bst2t_"+f),g=I(h)}catch(K){}var z,T=(z=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&
"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?"https:":Q(p.src),U="0";"https:"==T&&(U="1");h=c.rand;var V="__verify_callback_"+h,W="__tagObject_callback_"+h;window[V]=function(b){try{if(void 0==b.ResultID)document.write(1!=b?c.tagsrc:c.altsrc);else switch(b.ResultID){case 1:b.Passback?document.write(decodeURIComponent(b.Passback)):document.write(c.altsrc);break;case 2:case 3:document.write(c.tagsrc)}}catch(a){}};z?h="https:":(h="http:","http:"!=window._dv_win.location.protocol&&
(h="https:"));var C=h,X=z?"https:":Q(p.src),Y="0";"https:"===X&&(Y="1");var L=window._dv_win.document.visibilityState;window[W]=function(b){try{var a={};a.protocol=C;a.ssl=Y;a.dv_protocol=X;a.serverPublicDns=b.ServerPublicDns;a.ServerPublicDns=b.ServerPublicDns;a.tagElement=p;a.redirect=c;a.impressionId=b.ImpressionID;window._dv_win.$dvbsr.tags.add(b.ImpressionID,a);if(p.dvFrmWin){var e=window._dv_win.$dvbsr;p.dvFrmWin.$uid=b.ImpressionID;e.messages&&e.messages.startSendingEvents&&e.messages.startSendingEvents(p.dvFrmWin,
b.ImpressionID)}var d=function(){var a=window._dv_win.document.visibilityState;"prerender"===L&&("prerender"!==a&&"unloaded"!==a)&&(L=a,window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(f,d))};if("prerender"===L)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,{prndr:0});else{var f;"undefined"!==typeof window._dv_win.document.hidden?f="visibilitychange":
...
j[g],l=k.name.match(/.*\/(.+?)\./);if(l&&l[1]){var m=l[1].replace(/\d+$/,""),n=a[m];if(n){for(var q=0;q<n.stats.length;q++){var r=n.stats[q];e[n.prefix+r.prefix]=Math.round(k[r.name])}delete a[m];if(!Z(a))break}}}h=e;break b}catch(s){}h=void 0}i=h&&Z(h)?h:void 0;i&&window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,i)}catch(t){}};void 0==c.dvregion&&(c.dvregion=0);var M="",q=h="";try{for(var m=a,j=0;10>j&&m!=window.top;)j++,m=m.parent;a.depth=j;dv_additionalUrl=ba(a);h="&aUrl="+encodeURIComponent(dv_additionalUrl.url);
q="&aUrlD="+dv_additionalUrl.depth;M=a.depth+d;i&&a.depth--}catch(R){q=h=M=a.depth=""}void 0!=c.aUrl&&(h="&aUrl="+c.aUrl);var D;d=function(){try{return!!window.sessionStorage}catch(b){return!0}};i=function(){try{return!!window.localStorage}catch(b){return!0}};m=function(){var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var a=b.getContext("2d");a.textBaseline="top";a.font="14px 'Arial'";a.textBaseline="alphabetic";a.fillStyle="#f60";a.fillRect(0,0,62,20);a.fillStyle="#069";
...
if(null==n||""==n)D="";else{for(var d=function(a){for(var b="",c,e=7;0<=e;e--)c=a>>>4*e&15,b+=c.toString(16);return b},i=[1518500249,1859775393,2400959708,3395469782],n=n+String.fromCharCode(128),x=Math.ceil((n.length/4+2)/16),y=Array(x),m=0;m<x;m++){y[m]=Array(16);for(j=0;16>j;j++)y[m][j]=n.charCodeAt(64*m+4*j)<<24|n.charCodeAt(64*m+4*j+1)<<16|n.charCodeAt(64*m+4*j+2)<<8|n.charCodeAt(64*m+4*j+3)}y[x-1][14]=8*(n.length-1)/Math.pow(2,32);y[x-1][14]=Math.floor(y[x-1][14]);y[x-1][15]=8*(n.length-1)&
4294967295;for(var n=1732584193,j=4023233417,E=2562383102,F=271733878,G=3285377520,r=Array(80),A,s,u,v,H,m=0;m<x;m++){for(var k=0;16>k;k++)r[k]=y[m][k];for(k=16;80>k;k++)r[k]=(r[k-3]^r[k-8]^r[k-14]^r[k-16])<<1|(r[k-3]^r[k-8]^r[k-14]^r[k-16])>>>31;A=n;s=j;u=E;v=F;H=G;for(k=0;80>k;k++){var $=Math.floor(k/20),J=A<<5|A>>>27,B;c:{switch($){case 0:B=s&u^~s&v;break c;case 1:B=s^u^v;break c;case 2:B=s&u^s&v^u&v;break c;case 3:B=s^u^v;break c}B=void 0}var ca=J+B+H+i[$]+r[k]&4294967295;H=v;v=u;u=s<<30|s>>>
2;s=A;A=ca}n=n+A&4294967295;j=j+s&4294967295;E=E+u&4294967295;F=F+v&4294967295;G=G+H&4294967295}D=d(n)+d(j)+d(E)+d(F)+d(G)}}catch(ja){D=null}a=(window._dv_win&&window._dv_win.dv_config&&window._dv_win.dv_config.verifyJSCURL?dvConfig.verifyJSCURL+"?":T+"//rtb"+c.dvregion+".doubleverify.com/verifyc.js?")+c.dvparams+"&num=5&srcurlD="+a.depth+"&callback="+V+"&jsTagObjCallback="+W+"&ssl="+U+(z?"&dvf=0":"")+"&refD="+M+"&htmlmsging="+(l?"1":"0")+"&guid="+f+(null!=D?"&aadid="+D:"");b="dv_url="+encodeURIComponent(b);
if(!1==g||e)a=a+("&dvp_isBodyExistOnLoad="+(g?"1":"0"))+("&dvp_isOnHead="+(e?"1":"0"));if((e=window[N("=@42E:@?")][N("2?46DE@C~C:8:?D")])&&0<e.length){g=[];g[0]=window.location.protocol+"//"+window.location.hostname;for(f=0;f<e.length;f++)g[f+1]=e[f];e=g.reverse().join(",")}else e=null;e&&(b+="&ancChain="+encodeURIComponent(e));if(!1==/MSIE (\d+\.\d+);/.test(navigator.userAgent)||7<new Number(RegExp.$1)||2E3>=h.length+q.length+a.length)a+=q,b+=h;if(void 0!=window._dv_win.$dvbsr.CommonData.BrowserId&&
...
0,{}));b.hasOwnProperty("err")&&(c=b.err);return{vdcv:23,vdcd:b.res,err:c}}catch(a){return{vdcv:23,vdcd:"0",err:c}}}function Z(c){var b=0,a;for(a in c)c.hasOwnProperty(a)&&++b;return b}function ba(c){try{if(1>=c.depth)return{url:"",depth:""};var b,a=[];a.push({win:window.top,depth:0});for(var d,i=1,e=0;0<i&&100>e;){try{if(e++,d=a.shift(),i--,0<d.win.location.toString().length&&d.win!=c)return 0==d.win.document.referrer.length||0==d.depth?{url:d.win.location,depth:d.depth}:{url:d.win.document.referrer,
depth:d.depth-1}}catch(p){}b=d.win.frames.length;for(var f=0;f<b;f++)a.push({win:d.win.frames[f],depth:d.depth+1}),i++}return{url:"",depth:""}}catch(g){return{url:"",depth:""}}}function N(c){new String;var b=new String,a,d,i;for(a=0;a<c.length;a++)i=c.charAt(a),d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(i),0<=d&&(i="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94)),
b+=i;return b}function da(){try{if("function"===typeof window.callPhantom)return 99;try{if("function"===typeof window.top.callPhantom)return 99}catch(c){}if(void 0!=window.opera&&void 0!=window.history.navigationMode||void 0!=window.opr&&void 0!=window.opr.addons&&"function"==typeof window.opr.addons.installExtension)return 4;if(void 0!=window.chrome&&"function"==typeof window.chrome.csi&&"function"==typeof window.chrome.loadTimes&&void 0!=document.webkitHidden&&(!0==document.webkitHidden||!1==document.webkitHidden))return 3;
...
try {
	...
	dv_handler53.prototype = dv_baseHandlerIns;
dv_handler53.prototype.constructor = dv_handler53;

    var dv_handlersDefs = [{handler: new dv_handler53(), minRate: 0, maxRate: 90}];
