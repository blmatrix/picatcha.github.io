...
function dv_baseHandler(){function H(e,a){var d=document.createElement("iframe");d.name=window._dv_win.dv_config.emptyIframeID||"iframe_"+I();d.width=0;d.height=0;d.id=a;d.style.display="none";d.src=e;return d}function J(e,a,d){var d=d||150,c=window._dv_win||window;if(c.document&&c.document.body)return a&&a.parentNode?a.parentNode.insertBefore(e,a):c.document.body.insertBefore(e,c.document.body.firstChild),!0;if(0<d)setTimeout(function(){J(e,a,--d)},20);else return!1}function K(e){var a=null;try{if(a=
e&&e.contentDocument)return a}catch(d){}try{if(a=e.contentWindow&&e.contentWindow.document)return a}catch(c){}try{if(a=window._dv_win.frames&&window._dv_win.frames[e.name]&&window._dv_win.frames[e.name].document)return a}catch(b){}return null}function L(e,a,d,c,b,j,v,n,t,s){var g,i,f;void 0==a.dvregion&&(a.dvregion=0);var h,k,m;try{f=c;for(i=0;10>i&&f!=window._dv_win.top;)i++,f=f.parent;c.depth=i;g=N(c);h="&aUrl="+encodeURIComponent(g.url);k="&aUrlD="+g.depth;m=c.depth+b;j&&c.depth--}catch(I){k=h=
m=c.depth=""}void 0!=a.aUrl&&(h="&aUrl="+a.aUrl);b=a.script.src;j="&ctx="+(dv_GetParam(b,"ctx")||"")+"&cmp="+(dv_GetParam(b,"cmp")||"")+"&plc="+(dv_GetParam(b,"plc")||"")+"&sid="+(dv_GetParam(b,"sid")||"")+"&advid="+(dv_GetParam(b,"advid")||"")+"&adsrv="+(dv_GetParam(b,"adsrv")||"")+"&unit="+(dv_GetParam(b,"unit")||"")+"&isdvvid="+(dv_GetParam(b,"isdvvid")||"")+"&uid="+a.uid+"&tagtype="+(dv_GetParam(b,"tagtype")||"")+"&adID="+(dv_GetParam(b,"adID")||"")+"&app="+(dv_GetParam(b,"app")||"")+"&sup="+
(dv_GetParam(b,"sup")||"");(f=dv_GetParam(b,"xff"))&&(j+="&xff="+f);(f=dv_GetParam(b,"useragent"))&&(j+="&useragent="+f);if(void 0!=window._dv_win.$dvbs.CommonData.BrowserId&&void 0!=window._dv_win.$dvbs.CommonData.BrowserVersion&&void 0!=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent)g=window._dv_win.$dvbs.CommonData.BrowserId,i=window._dv_win.$dvbs.CommonData.BrowserVersion,f=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent;else{var u=f?decodeURIComponent(f):navigator.userAgent;g=
...
verRegex:"Version/"}];f=0;i="";for(var r=0;r<g.length;r++)if(null!=u.match(RegExp(g[r].brRegex))){f=g[r].id;if(null==g[r].verRegex)break;u=u.match(RegExp(g[r].verRegex+"[0-9]*"));null!=u&&(i=u[0].match(RegExp(g[r].verRegex)),i=u[0].replace(i[0],""));break}g=r=O();i=r===f?i:"";window._dv_win.$dvbs.CommonData.BrowserId=g;window._dv_win.$dvbs.CommonData.BrowserVersion=i;window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent=f}j+="&brid="+g+"&brver="+i+"&bridua="+f;(f=dv_GetParam(b,"turl"))&&(j+="&turl="+
f);(f=dv_GetParam(b,"tagformat"))&&(j+="&tagformat="+f);f="";try{var p=window._dv_win.parent;f+="&chro="+(void 0===p.chrome?"0":"1");f+="&hist="+(p.history?p.history.length:"");f+="&winh="+p.innerHeight;f+="&winw="+p.innerWidth;f+="&wouh="+p.outerHeight;f+="&wouw="+p.outerWidth;p.screen&&(f+="&scah="+p.screen.availHeight,f+="&scaw="+p.screen.availWidth)}catch(J){}var j=j+f,A;p=function(){try{return!!window.sessionStorage}catch(a){return!0}};f=function(){try{return!!window.localStorage}catch(a){return!0}};
...
0,{}))}}catch(e){return{vdcv:18,vdcd:"0"}}}function N(e){try{if(1>=e.depth)return{url:"",depth:""};var a,d=[];d.push({win:window._dv_win.top,depth:0});for(var c,b=1,j=0;0<b&&100>j;){try{if(j++,c=d.shift(),b--,0<c.win.location.toString().length&&c.win!=e)return 0==c.win.document.referrer.length||0==c.depth?{url:c.win.location,depth:c.depth}:{url:c.win.document.referrer,depth:c.depth-1}}catch(v){}a=c.win.frames.length;for(var n=0;n<a;n++)d.push({win:c.win.frames[n],depth:c.depth+1}),b++}return{url:"",
depth:""}}catch(t){return{url:"",depth:""}}}function G(e){new String;var a=new String,d,c,b;for(d=0;d<e.length;d++)b=e.charAt(d),c="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(b),0<=c&&(b="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((c+47)%94)),a+=b;return a}function I(){return Math.floor(1E12*(Math.random()+""))}function O(){try{if("function"===typeof window.callPhantom)return 99;
...
a.parent&&a.parent!=a)if(0<a.parent.location.toString().length)a=a.parent,d++,e=!0;else{e=!1;break}else{0==b&&(e=!0);break}}catch(j){e=!1}0==a.document.referrer.length?e=a.location:e?e=a.location:(e=a.document.referrer,c=!0);if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};var v;v=!window._dv_win.dv_config||!window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal.pop():window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-
1];b=v.script;this.dv_script_obj=v;this.dv_script=b;window._dv_win.dvbsProcessed.push(v);window._dv_win._dvScripts.push(b);var n=b.src;this.dvOther=0;this.dvStep=1;var t;t=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():I():I();var s;v=window.parent.postMessage&&window.JSON;var g=!0,i=!1;if("0"==dv_GetParam(n,"t2te")||window._dv_win.dv_config&&!0==window._dv_win.dv_config.supressT2T)i=
!0;if(v&&!1==i)try{s=H(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+t),g=J(s)}catch(f){}var h;s={};try{for(var k=RegExp("[\\?&]([^&]*)=([^&#]*)","gi"),m=k.exec(n);null!=m;)"eparams"!==m[1]&&(s[m[1]]=m[2]),m=k.exec(n);h=s}catch(K){h=s}h.perf=this.perf;h.uid=t;h.script=this.dv_script;h.callbackName="__verify_callback_"+h.uid;h.tagObjectCallbackName="__tagObject_callback_"+h.uid;h.tagAdtag=null;h.tagPassback=null;h.tagIntegrityFlag="";h.tagHasPassbackFlag=
"";if(!1==(null!=h.tagformat&&"2"==h.tagformat)){var k=h.script,u=null,r=null,p;s=k.src;m=dv_GetParam(s,"cmp");s=dv_GetParam(s,"ctx");p="919838"==s&&"7951767"==m||"919839"==s&&"7939985"==m||"971108"==s&&"7900229"==m||"971108"==s&&"7951940"==m?"</scr'+'ipt>":/<\/scr\+ipt>/g;"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var G=function(a){if((a=a.previousSibling)&&"#text"==a.nodeName&&(null==a.nodeValue||void 0==a.nodeValue||0==a.nodeValue.trim().length))a=
a.previousSibling;if(a&&"SCRIPT"==a.tagName&&a.getAttribute("type")&&("text/adtag"==a.getAttribute("type").toLowerCase()||"text/passback"==a.getAttribute("type").toLowerCase())&&""!=a.innerHTML.trim()){if("text/adtag"==a.getAttribute("type").toLowerCase())return u=a.innerHTML.replace(p,"<\/script>"),{isBadImp:!1,hasPassback:!1,tagAdTag:u,tagPassback:r};if(null!=r)return{isBadImp:!0,hasPassback:!1,tagAdTag:u,tagPassback:r};r=a.innerHTML.replace(p,"<\/script>");a=G(a);a.hasPassback=!0;return a}return{isBadImp:!0,
...
typeof window._dv_win.document.mozHidden?d="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?d="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(d="webkitvisibilitychange");window._dv_win.document.addEventListener(d,e,!1)}}};window[l.callbackName]=function(a){var b;b=window._dv_win.$dvbs&&"object"==typeof window._dv_win.$dvbs.tags[w]?window._dv_win.$dvbs.tags[w]:l;l.perf&&l.perf.addTime("r7");var c=window._dv_win.dv_config.bs_renderingMethod||
...
a.AdWidth+"px%3B%20height%3A%20"+a.AdHeight+"px%3B%22%3E%09%0A%3C%2Fdiv%3E"))}};this.perf&&this.perf.addTime("r4");b=b&&b.parentElement&&b.parentElement.tagName&&"HEAD"===b.parentElement.tagName;this.dvStep=3;return L(this,h,e,a,d,c,v,g,b,A)};this.sendRequest=function(e){this.perf&&this.perf.addTime("r5");var a=dv_GetParam(e,"tagformat");a&&"2"==a?$dvbs.domUtilities.addScriptResource(e,document.body):dv_sendScriptRequest(e);this.perf&&this.perf.addTime("r6");try{var d,c=this.dv_script_obj&&this.dv_script_obj.injScripts,
b=window._dv_win.dv_config=window._dv_win.dv_config||{};b.cdnAddress=b.cdnAddress||"cdn.doubleverify.com";d='<html><head><script type="text/javascript">('+function(){try{window.$dv=window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(a){}}.toString()+')();<\/script></head><body><script type="text/javascript">('+(c||"function() {}")+')("'+b.cdnAddress+'");<\/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);<\/script></body></html>';var j=H("about:blank");
j.id=j.name;var v=j.id.replace("iframe_","");j.setAttribute&&j.setAttribute("data-dv-frm",v);J(j,this.dv_script);if(this.dv_script){var n=this.dv_script,t;a:{e=null;try{if(e=j.contentWindow){t=e;break a}}catch(s){}try{if(e=window._dv_win.frames&&window._dv_win.frames[j.name]){t=e;break a}}catch(g){}t=null}n.dvFrmWin=t}var i=K(j);if(i)i.open(),i.write(d);else{try{document.domain=document.domain}catch(f){}var h=encodeURIComponent(d.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));j.src='javascript: (function(){document.open();document.domain="'+
window.document.domain+"\";document.write('"+h+"');})()"}}catch(k){d=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(d+"/verify.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(k)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=L);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"71"}};
