...
var secureServerName = "uat-secure.technoratimedia.com";
var icount = 1;
...
var baseServerName = (myScript.src.substr(0, 5) === 'https' && secureServerName) ? secureServerName : serverName;
var newBaseURL = myScript.src.replace(/^(https?):\/\/[^\/]*(.*\/\d+\/\d+\/\d+\/)uat_(\d+).js\??.*/, "$1://" + baseServerName + "$2adserv_$3.js");
