...
(function(){
    ...
    getBackup: function(div) {
        ...
        div.innerHTML = '<a id="fta' + o.altImgID + '" href="' + href + '" target="' + o.altImgTarget + '"><img sr' + 'c="' + impression + '?' + o.random() + '" alt="' + o.altText + '" style="width:' + o.width + 'px; height:' + o.height + 'px; border:0px"/></a>';
        return div;
    },
    ...
    outputDiv: function(fullAd) {
        var phDiv = null, cssText = 'width:' + o.width + 'px; height:' + o.height + 'px; position:' + o.pubPos(), div = document.createElement('div'), badWrite = !(document.write instanceof Function && ~document.write.toString().indexOf('[native code]'));
    ...
    receive: function(e) {
        var msg = null, newGUID = false, info;
                ...
                switch (info.method) {
                  case 'ready':
                    ...
                    msg = {
                        ...
                        serveDOM: o.serveDOM,
                        mvt: o.mvt,
                        api: !o.VPAID && o.api._BRIDGE === o.api.fallbackAPI ? 'ft' : 'ext',
                        guid: o.GUID,
                        newGUID: newGUID,
    ...
    setupClickTags: function() {
        ...
        var i = clicks.length;
        while (i--) {
            o.clicks['clickTag' + (i + 1)] = o.convertUrlProtocol(o.addVClick(clicks[i]));
        }
    ...
    (function() {
    var p = "2229601", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2229601||'',
    GUID:window.ftGUID_2229601||'99999999999',
    confID:window.ftConfID_2229601||'0',
    ftReturn: window.ftReturn_2229601||'',
    keyword:window.ftKeyword_2229601||'',
    ftId:window.ftId_2229601||'',
    imp:window.ftImp2229601,
    ftImpId:window.ftImp2229601 && window.ftImp2229601.impID || '',
    campaignID:'70889',
    cID:'68251',
    pID:'2229601',
    creativeID:'1624314',
    exttrack:["https://ad.doubleclick.net/ddm/ad/N7293.285378.OMGTRADINGDESKDATAM/B10607587.141481985;sz=1x1;ord=[timestamp]?[noCachebuster]","https://d.agkn.com/pixel/7421/?che=[FT_Random]&col=70889,4151,2229601,1624314,[%FT_CONFID%],,[%FT_GUID%]","https://adadvisor.net/adscores/g.json?sid=9212273488&guid=[%FT_GUID%][noCachebuster]"],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/4/70889;2229601;1624314;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://d.agkn.com/pixel/7422/?che=[%FT_RANDOM%]&col=70889,4151,1H17_IMVS_Accuen_D_D_P_DCO_PD_RON_FT_BT_YAM_Lookalike_300x250_no_Natl_CPM_Mid_DCO,1624314,[%FT_CONFID%],,[%FT_GUID%],,,&l0=https://ad.doubleclick.net/ddm/clk/313704622;141481985;e","http://servedby.flashtalking.com/click/4/70889;2229601;1624314;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://d.agkn.com/pixel/7422/?che=[%FT_RANDOM%]&col=70889,4151,1H17_IMVS_Accuen_D_D_P_DCO_PD_RON_FT_BT_YAM_Lookalike_300x250_no_Natl_CPM_Mid_DCO,1624314,[%FT_CONFID%],,[%FT_GUID%],,,&l0=https://ad.doubleclick.net/ddm/clk/313704622;141481985;e"],
    placementDescription:'1H17IMVSAccuenDDPDCOPDRONFTBTYAMLookalike300x250noNatlCPMMidDCO',
    width:300,
    height:250,
    ...
    divID:'ftdiv2229601',
    phID:'ftpos2229601',
    frameID:'ftframe2229601',
    expID:'ftexpframe2229601',
    altImgID:'ftalt2229601',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/4/70889;2229601;1624314;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://d.agkn.com/pixel/7422/?che=[%FT_RANDOM%]&col=70889,4151,1H17_IMVS_Accuen_D_D_P_DCO_PD_RON_FT_BT_YAM_Lookalike_300x250_no_Natl_CPM_Mid_DCO,1624314,[%FT_CONFID%],,[%FT_GUID%],,,&l0=https://ad.doubleclick.net/ddm/clk/313704622;141481985;e',
    altImg:'http://servedby.flashtalking.com/imp/4/70889;2229601;204;gif;AccuenUS;1H17IMVSAccuenDDPDCOPDRONFTBTYAMLookalike300x250noNatlCPMMidDCO/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/4/70889;2229601;271;pixel;AccuenUS;1H17IMVSAccuenDDPDCOPDRONFTBTYAMLookalike300x250noNatlCPMMidDCO/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/4/70889;2229601;207;guid;AccuenUS;1H17IMVSAccuenDDPDCOPDRONFTBTYAMLookalike300x250noNatlCPMMidDCO/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/222/2229601/1624314/js/j-2229601-1624314.js',
    file:'http://cdn.flashtalking.com/68251/1624314/Main.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?73594005-2229601;1624314;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_2229601||'',
    segmentList:window.ftSegmentList_2229601||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2229601 && window.ftImp2229601.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2229601')&&/^https:/.test(document.getElementById('ftscript_m2229601').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2229601'),
    ...
    switchArray:['file', 'serveDOM', 'serveDom', 'statBaseURL', 'utilityURL', 'altImg', 'altImgHref', 'viewableImpressionURL', 'iDeviceImp'],
    qsVars:[
        ['ftguid', 'ftGUID_2229601'],
        ['ftcfid', 'ftConfID_2229601'],
        ['fttime', 'ftTimestamp_2229601'],
        ['ftsection', 'ftSection_2229601'],
        ['ftcustom', 'ftCustom_2229601'],
        ['ft_id', 'ftId_2229601'],
        ['ftimpid','ftImp2229601', 'impID']
    ]
};
