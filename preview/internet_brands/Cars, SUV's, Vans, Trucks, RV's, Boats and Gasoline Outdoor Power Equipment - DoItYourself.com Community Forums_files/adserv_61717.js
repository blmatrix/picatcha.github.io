...
var varTmxRequestId='7097956534654600';
var varPassOapp='';
...
function TMX_OpenX(auid) {
  ...
  tmxDoc.write("               document.write('<scr' + 'ipt src=\"\/\/uat-net.technoratimedia.com\/pixel?rid=7097956534654600&id=2&rev=3&typ=apndef&bid=OPX&mkt=11&sid=61717&cp=' + a.getProperties().pub_rev + '\"> <\/scr' + 'ipt>');");
  tmxDoc.writeln("	}");
  tmxDoc.writeln("});");
...
function TMX_DefaultOrPSA(qs) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=7097956534654600&id=4&' + qs + '"></scr' + 'ipt>');
  } else {
   document.write('<scr' + 'ipt type="text/javascript" src="' + (tmIsSecure ? 'https://uat-net' : 'http://ad-cdn') + '.technoratimedia.com/psa/psa.js' +'"></scr' + 'ipt>');;
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=7097956534654600&id=3&' + qs + '"></scr' + 'ipt>');
  }
...
function TMX_Return() {
    tmxDoc.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=7097956534654600&id=7"></scr' + 'ipt>');
	varTmxOpx=0;
	TMX_APN('1');
}
function TMX_SetDocument(doc) {
  console.log("TMX_SetDocument 61717 7097956534654600", doc);
  tmxDoc=doc;
}
